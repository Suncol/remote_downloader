...
echo ${download_year}
python yearly_downloader.py -y ${download_year} -mb 1 -me 6 >> log
python yearly_downloader.py -y ${download_year} -mb 7 -me 12  & { sleep 10; pkill -9 -f yearly_downloader.py & }
exit
remotessh
...
ssh -tt root@$remote_server << remotessh
python yearly_downloader.py -y ${download_year} -mb 7 -me 12 >> log
exit
remotessh
rsync -avPh root@$remote_server:/root/ERA5* .
ssh -tt root@$remote_server << remotessh
